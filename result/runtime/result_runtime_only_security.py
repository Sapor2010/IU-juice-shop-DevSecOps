...
############ Step 4 visualize 
g = sns.barplot(data=results_df, x='typ', y='average_duration_security')
...
fig.savefig("result/runtime/avarage_duration_summery_only_security.svg", format='svg')
plt.show()


results_df.to_excel('result/runtime/result_only_security.xlsx')