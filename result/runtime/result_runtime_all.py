...
results_df['average_cccr_s'] = dat.groupby(['typ'])['Codeclimate Coverage Report'].mean().dt.total_seconds() / 60
...
############ Step 4 visualize 
g = sns.barplot(data=results_df,palette="viridis")
...
plt.savefig("result/runtime/avarage_duration_summery_all.svg", format='svg')
plt.show()


results_df.to_excel('result/runtime/result_all.xlsx')